...
{
	public class ExposeFromItemTestCase : TestCase
	{
		private IEnumerable<Item> SitecoreItems;
		protected readonly ISpawnProvider SpawnProvider;

		public ExposeFromItemTestCase(IItemFactory fortisService, ISitecoreContext glassService, ISpawnProvider spawnProvider) 
		...
		protected override void ExecuteGlassTest()
		{
			foreach (var item in this.SitecoreItems)
			{
				var obj = item.GlassCast<INavigation>();
			}
		}
	}
}